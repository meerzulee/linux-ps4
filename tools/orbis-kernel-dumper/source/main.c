...
int _main(struct thread *td) {
  ...
  unlink(save_file);  /* always re-dump */
  ...
  printf_notification("USB detected (%s). Computing kernel size...", usb_name);
  ...
  printf_notification("Power off the PS4 and pull the USB to retrieve.");
